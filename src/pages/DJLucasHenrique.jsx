...
import djLucasHenriqueImage from '../assets/djlucashenrique-nTxNP4Wz.webp';
  ...
  return (
    <div style={{
      ...
      >
        ...
        >
          {[
            { label: "YouTube Inscritos", value: "8.8K", icon: Youtube, color: "#ff0000" },
