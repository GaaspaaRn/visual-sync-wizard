...
// LazySpotifyEmbed foi removido pois não é mais usado
import { LazyYouTubeEmbed, LazyInstagramEmbed } from '../components/PerformanceOptimizer';
...
const Diguera = () => {
  ...
  return (
    <PerformanceOptimizer>
      <SEOHead 
        title="DJ Diguera | Gruv Label - Electronic Music Producer"
        description="DJ Diguera - Producer de música eletrônica com 2.46K inscritos no YouTube e 627,512 visualizações. Contrate DJ Diguera para seu evento."
        image="/assets/djdigoidg.webp"
        url="/diguera"
        artist={{
          name: "DJ Diguera",
      ...
      <FixedFloatingButton 
        djName="DJ DIGUERA"
        whatsappMessage="Olá, gostaria de contratar o DJ Diguera."
      />
        ...
        >
          ...
          >
            ...
            <div style={{
              ...
              <Suspense fallback={<div className="lazy-placeholder" style={{height: '352px', borderRadius: '12px', background: 'rgba(255, 255, 255, 0.1)'}}></div>}>
                <iframe 
                  title="Spotify Album Player for DJ Diguera"
                  data-testid="embed-iframe" 
                  style={{ borderRadius: '12px', border: 'none', display: 'block' }}
                  src="https://open.spotify.com/embed/album/1qyY4y4lPjTZzHDdalOD2W?utm_source=generator" 
                  width="100%" 
                  height="352" 
                  allowFullScreen="" 
          ...
          >
            ...
            <div style={{
              ...
              <Suspense fallback={<div className="lazy-placeholder" style={{height: '150px', borderRadius: '12px', background: 'rgba(255, 255, 255, 0.1)'}}></div>}>
                <LazyYouTubeEmbed videoId="J4SezJtNvq8" title="DJ Diguera - YouTube" />
              </Suspense>
            </div>
          </motion.div>
