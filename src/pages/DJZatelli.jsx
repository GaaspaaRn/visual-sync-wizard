      ...
      <div style={{
        ...
        >
          ...
          <motion.div 
            ...
            variants={itemVariants}
          >
            <a href={artistData.socialLinks.spotify} target="_blank" rel="noopener noreferrer" aria-label="Spotify">
              <motion.div
                style={{
                  width: '40px',
                  height: '40px',
            ...
            <a href={artistData.socialLinks.youtube} target="_blank" rel="noopener noreferrer" aria-label="YouTube">
              <motion.div
                style={{
                  width: '40px',
                  height: '40px',
            ...
            <a href={artistData.socialLinks.instagram} target="_blank" rel="noopener noreferrer" aria-label="Instagram">
              <motion.div
                style={{
                  width: '40px',
                  height: '40px',
          ...
          >
            ...
            <Suspense fallback={<div style={{ height: '152px', background: 'rgba(0,0,0,0.6)', borderRadius: '12px' }}></div>}>
              <LazySpotifyEmbed trackId="6BlnhPe8oMmJndqOneit2U" title="DJ Zatelli - Música no Spotify" />
            </Suspense>
          </motion.div>
          ...
          >
            ...
            <Suspense fallback={<div style={{ height: '150px', background: 'rgba(0,0,0,0.6)', borderRadius: '12px' }}></div>}>
              <LazyYouTubeEmbed videoId="wkBYS1pkY8s" title="DJ Zatelli - YouTube" />
            </Suspense>
          </motion.div>

          {/* Lazy-loaded Instagram Post */}
          <motion.div 
            style={{
              marginBottom: '1.5rem',
              maxWidth: '400px',
          ...
          >
            ...
            <Suspense fallback={<div style={{ height: '400px', background: 'rgba(0,0,0,0.6)', borderRadius: '12px' }}></div>}>
              <LazyInstagramEmbed 
                postUrl="https://www.instagram.com/p/DMgUV9hvwa6/" 
